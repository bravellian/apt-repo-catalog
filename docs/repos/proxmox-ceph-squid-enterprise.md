...
echo "deb [signed-by=/usr/share/keyrings/proxmox-archive-keyring-trixie.gpg] https://enterprise.proxmox.com/debian/ceph-squid trixie enterprise" | sudo tee /etc/apt/sources.list.d/proxmox-ceph-squid-enterprise-trixie.list >/dev/null
sudo apt-get update
```
