# Microsoft - ubuntu-20.10 - default

## Repository
- Repository ID: `microsoft-default-ubuntu-20-10-groovy-packages-microsoft-com`
- Base URL: `https://packages.microsoft.com/ubuntu/20.10/prod`
...
echo "deb [arch=amd64,armhf,arm64 signed-by=/usr/share/keyrings/microsoft-microsoft-eb3e94adbe1229cf.gpg] https://packages.microsoft.com/ubuntu/20.10/prod groovy main" | sudo tee /etc/apt/sources.list.d/microsoft-default-ubuntu-20-10-groovy-packages-microsoft-com-groovy.list >/dev/null
sudo apt-get update
```
