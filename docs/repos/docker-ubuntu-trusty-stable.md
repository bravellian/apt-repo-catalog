# Docker - Ubuntu (Trusty) - stable (ubuntu-14.04)

## Repository
- Repository ID: `docker-ubuntu-trusty-stable`
- OS: `ubuntu-14.04`
- Source: `https://download.docker.com/linux/ubuntu trusty stable`
...
echo "deb [signed-by=/usr/share/keyrings/docker-gpg-8d81803c0ebfcd88.gpg] https://download.docker.com/linux/ubuntu trusty stable" | sudo tee /etc/apt/sources.list.d/docker-ubuntu-trusty-stable.list >/dev/null
sudo apt-get update
```
