# Microsoft - debian-10 - default (debian-10)

Repository ID: `microsoft-default-debian-10-buster-packages-microsoft-com`
OS: `debian-10`
Source: `[arch=amd64] https://packages.microsoft.com/debian/10/prod buster main`
...
echo "deb [signed-by=/usr/share/keyrings/microsoft-microsoft-eb3e94adbe1229cf.gpg] [arch=amd64] https://packages.microsoft.com/debian/10/prod buster main" | sudo tee /etc/apt/sources.list.d/microsoft-default-debian-10-buster-packages-microsoft-com.list >/dev/null
sudo apt-get update
```
