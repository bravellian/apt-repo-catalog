# Docker - Ubuntu (Noble) - stable (ubuntu-24.04)

## Repository
- Repository ID: `docker-ubuntu-noble-stable`
- OS: `ubuntu-24.04`
- Source: `https://download.docker.com/linux/ubuntu noble stable`
...
echo "deb [signed-by=/usr/share/keyrings/docker-gpg-8d81803c0ebfcd88.gpg] https://download.docker.com/linux/ubuntu noble stable" | sudo tee /etc/apt/sources.list.d/docker-ubuntu-noble-stable.list >/dev/null
sudo apt-get update
```
...
- **docker-model-plugin**
  - Latest version: 1.0.7-1~ubuntu.24.04~noble
  - Architectures: amd64
  - Suite: noble
  - Components: stable
