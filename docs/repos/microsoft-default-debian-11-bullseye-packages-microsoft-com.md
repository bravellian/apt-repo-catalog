# Microsoft - debian-11 - default

## Repository
- Repository ID: `microsoft-default-debian-11-bullseye-packages-microsoft-com`
- Base URL: `https://packages.microsoft.com/debian/11/prod`
...
echo "deb [arch=amd64,armhf,arm64 signed-by=/usr/share/keyrings/microsoft-microsoft-eb3e94adbe1229cf.gpg] https://packages.microsoft.com/debian/11/prod bullseye main" | sudo tee /etc/apt/sources.list.d/microsoft-default-debian-11-bullseye-packages-microsoft-com-bullseye.list >/dev/null
sudo apt-get update
```
