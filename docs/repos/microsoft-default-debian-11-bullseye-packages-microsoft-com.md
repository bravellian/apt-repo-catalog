# Microsoft - debian-11 - default (debian-11)

## Repository
- Repository ID: `microsoft-default-debian-11-bullseye-packages-microsoft-com`
- OS: `debian-11`
- Source: `[arch=amd64,armhf,arm64] https://packages.microsoft.com/debian/11/prod bullseye main`

## Upstream documentation
- Documentation URL: https://packages.microsoft.com/config/debian/11
...
echo "deb [signed-by=/usr/share/keyrings/microsoft-microsoft-eb3e94adbe1229cf.gpg] [arch=amd64,armhf,arm64] https://packages.microsoft.com/debian/11/prod bullseye main" | sudo tee /etc/apt/sources.list.d/microsoft-default-debian-11-bullseye-packages-microsoft-com.list >/dev/null
sudo apt-get update
```
...
<details>
<summary>Packages (126)</summary>

<div class="packages-nav">
<a href="#packages-A">A</a> <a href="#packages-B">B</a> <a href="#packages-D">D</a> <a href="#packages-H">H</a> <a href="#packages-I">I</a> <a href="#packages-J">J</a> <a href="#packages-L">L</a> <a href="#packages-M">M</a> <a href="#packages-N">N</a> <a href="#packages-O">O</a> <a href="#packages-P">P</a> <a href="#packages-S">S</a> <a href="#packages-U">U</a> <a href="#packages-V">V</a> <a href="#packages-W">W</a>
</div>
...
- **aadsshlogin**
  ...
  - Section: utils
  - Priority: optional
  - depends: libc6 (>= 2.25), libcurl4, libcurl4 (>= 7.16.2), libpam0g (>= 0.99.7.1), libselinux1 (>= 3.1~), libsemanage1 (>= 2.0.32), libssl1.1 (>= 1.1.0), libuuid1, libuuid1 (>= 2.16), openssh-server (>=6.9), passwd
  - preDepends: grep, sed
  - conflicts: aadlogin
...
- **aadsshlogin-selinux**
  ...
  - Section: utils
  - Priority: optional
  - depends: policycoreutils (>=3.1-3), selinux-policy-default, selinux-utils
...
- **aspnetcore-runtime-2.1**
  ...
  - Section: devel
  - Priority: standard
  - depends: dotnet-runtime-2.1 (>= 2.1.30), libc6 (>= 2.14)
...
- **aspnetcore-runtime-5.0**
  ...
  - Section: devel
  - Priority: standard
  - depends: dotnet-runtime-5.0 (>= 5.0.10), dotnet-runtime-5.0 (>= 5.0.11), dotnet-runtime-5.0 (>= 5.0.12), dotnet-runtime-5.0 (>= 5.0.13), dotnet-runtime-5.0 (>= 5.0.14), dotnet-runtime-5.0 (>= 5.0.15), dotnet-runtime-5.0 (>= 5.0.16), dotnet-runtime-5.0 (>= 5.0.17), dotnet-runtime-5.0 (>= 5.0.9)
...
- **aspnetcore-runtime-8.0**
  ...
  - Section: devel
  - Priority: standard
  - depends: dotnet-runtime-8.0 (>= 8.0.0), dotnet-runtime-8.0 (>= 8.0.1), dotnet-runtime-8.0 (>= 8.0.10), dotnet-runtime-8.0 (>= 8.0.11), dotnet-runtime-8.0 (>= 8.0.12), dotnet-runtime-8.0 (>= 8.0.2), dotnet-runtime-8.0 (>= 8.0.3), dotnet-runtime-8.0 (>= 8.0.4), dotnet-runtime-8.0 (>= 8.0.5), dotnet-runtime-8.0 (>= 8.0.6), dotnet-runtime-8.0 (>= 8.0.7), dotnet-runtime-8.0 (>= 8.0.8)

  </details>

- **aspnetcore-runtime-9.0**
  - Latest version: 9.0.1-1
  - Architectures: amd64
  - Suite: bullseye
  - Components: main
  - Description: Shared Framework for hosting of Microsoft ASP.NET Core applications. It is open source, cross-platform and is supported by Microsoft. We hope you enjoy using it! If you do, please consider joining the active community of developers that are contributing to the project on GitHub (https://github.com/dotnet/aspnetcore). We happily accept issues and PRs.
  ...
  - Section: devel
  - Priority: standard
  - depends: dotnet-runtime-9.0 (>= 9.0.1)
...
- **aspnetcore-targeting-pack-8.0**
  ...
  - Section: devel
  - Priority: standard
  - depends: dotnet-targeting-pack-8.0 (>= 8.0.0), dotnet-targeting-pack-8.0 (>= 8.0.1), dotnet-targeting-pack-8.0 (>= 8.0.10), dotnet-targeting-pack-8.0 (>= 8.0.11), dotnet-targeting-pack-8.0 (>= 8.0.12), dotnet-targeting-pack-8.0 (>= 8.0.2), dotnet-targeting-pack-8.0 (>= 8.0.3), dotnet-targeting-pack-8.0 (>= 8.0.4), dotnet-targeting-pack-8.0 (>= 8.0.5), dotnet-targeting-pack-8.0 (>= 8.0.6), dotnet-targeting-pack-8.0 (>= 8.0.7), dotnet-targeting-pack-8.0 (>= 8.0.8)
...
- **aspnetcore-targeting-pack-9.0**
  ...
  - Section: devel
  - Priority: standard
  - depends: dotnet-targeting-pack-9.0 (>= 9.0.1)
...
- **aziot-edge-dbgsym**
  ...
  - Section: debug
  - Priority: optional
  - depends: aziot-edge (= 1.4.41-1), aziot-edge (= 1.5.10-1), aziot-edge (= 1.5.13-1), aziot-edge (= 1.5.16-1), aziot-edge (= 1.5.7-1), aziot-edge (= 1.5.8-1)
...
- **aziot-identity-service**
  ...
  - Section: admin
  - Priority: optional
  - depends: libc6 (>= 2.28), libc6 (>= 2.29), libgcc-s1 (>= 4.3), libssl1.1 (>= 1.1.0g), libtss2-esys-3.0.2-0 (>= 2.3.1), libtss2-mu0 (>= 3.0.1), libtss2-rc0 (>= 3.0.1), libtss2-tctildr0 (>= 3.0.1), psmisc
...
- **aziot-identity-service-dbgsym**
  ...
  - Section: debug
  - Priority: optional
  - depends: aziot-identity-service (= 1.4.9-1), aziot-identity-service (= 1.5.1-1), aziot-identity-service (= 1.5.2-1), aziot-identity-service (= 1.5.3-1), aziot-identity-service (= 1.5.4-1), aziot-identity-service (= 1.5.5-1)
...
- **deliveryoptimization-agent**
  ...
  - Section: devel
  - Priority: optional
  - depends: libc6 (>= 2.30), libcurl4 (>= 7.16.2), libgcc-s1 (>= 3.0), libgcc-s1 (>= 3.5), libproxy1v5 (>= 0.4.17), libstdc++6 (>= 9)
...
- **deviceupdate-agent**
  ...
  - Section: admin
  - Priority: extra
  - depends: curl, deliveryoptimization-agent (>= 1.0.0), libc6 (>= 2.30), libcurl4 (>= 7.18.2), libcurl4-openssl-dev, libdeliveryoptimization (>= 1.0.0), libgcc-s1 (>= 3.0), libgcc-s1 (>= 3.5), libssl1.1 (>= 1.1.1), libstdc++6 (>= 9), libxml2 (>= 2.7.4)
...
- **dotnet-apphost-pack-5.0**
  ...
  - Suite: bullseye
  - Components: main
  - Description: Microsoft.NETCore.App.Host 5.0.14
  - Homepage: https://github.com/dotnet/core
...
- **dotnet-hostfxr-2.1**
  ...
  - Section: libs
  - Priority: standard
  - depends: dotnet-host (>= 2.1.30), libc6, libgcc1, libstdc++6
...
- **dotnet-hostfxr-5.0**
  ...
  - Suite: bullseye
  - Components: main
  - Description: Microsoft .NET Host FX Resolver - 5.0.15 5.0.15
  - Homepage: https://dot.net/core
  ...
  - Section: libs
  - Priority: standard
  - depends: dotnet-host (>= 5.0.10), dotnet-host (>= 5.0.11), dotnet-host (>= 5.0.12), dotnet-host (>= 5.0.13), dotnet-host (>= 5.0.14), dotnet-host (>= 5.0.15), dotnet-host (>= 5.0.16), dotnet-host (>= 5.0.17), dotnet-host (>= 5.0.9), libc6, libgcc1, libstdc++6
...
- **dotnet-hostfxr-8.0**
  ...
  - Section: libs
  - Priority: standard
  - depends: dotnet-host (>= 8.0.0), dotnet-host (>= 8.0.1), dotnet-host (>= 8.0.10), dotnet-host (>= 8.0.11), dotnet-host (>= 8.0.12), dotnet-host (>= 8.0.2), dotnet-host (>= 8.0.3), dotnet-host (>= 8.0.4), dotnet-host (>= 8.0.5), dotnet-host (>= 8.0.6), dotnet-host (>= 8.0.7), dotnet-host (>= 8.0.8), libc6, libgcc1, libstdc++6
...
- **dotnet-hostfxr-9.0**
  ...
  - Section: libs
  - Priority: standard
  - depends: dotnet-host (>= 9.0.1), libc6, libgcc1, libstdc++6
...
- **dotnet-runtime-2.1**
  ...
  - Section: libs
  - Priority: standard
  - depends: dotnet-hostfxr-2.1 (>= 2.1.30), dotnet-runtime-deps-2.1 (>= 2.1.30)
...
- **dotnet-runtime-3.1**
  ...
  - Section: libs
  - Priority: standard
  - depends: dotnet-hostfxr-3.1 (>= 3.1.18), dotnet-hostfxr-3.1 (>= 3.1.19), dotnet-hostfxr-3.1 (>= 3.1.20), dotnet-hostfxr-3.1 (>= 3.1.21), dotnet-hostfxr-3.1 (>= 3.1.22), dotnet-hostfxr-3.1 (>= 3.1.23), dotnet-hostfxr-3.1 (>= 3.1.24), dotnet-hostfxr-3.1 (>= 3.1.25), dotnet-hostfxr-3.1 (>= 3.1.26), dotnet-hostfxr-3.1 (>= 3.1.27), dotnet-hostfxr-3.1 (>= 3.1.28), dotnet-hostfxr-3.1 (>= 3.1.29), dotnet-hostfxr-3.1 (>= 3.1.30), dotnet-hostfxr-3.1 (>= 3.1.31), dotnet-hostfxr-3.1 (>= 3.1.32), dotnet-runtime-deps-3.1 (>= 3.1.18), dotnet-runtime-deps-3.1 (>= 3.1.19), dotnet-runtime-deps-3.1 (>= 3.1.20), dotnet-runtime-deps-3.1 (>= 3.1.21), dotnet-runtime-deps-3.1 (>= 3.1.22), dotnet-runtime-deps-3.1 (>= 3.1.23), dotnet-runtime-deps-3.1 (>= 3.1.24), dotnet-runtime-deps-3.1 (>= 3.1.25), dotnet-runtime-deps-3.1 (>= 3.1.26), dotnet-runtime-deps-3.1 (>= 3.1.27), dotnet-runtime-deps-3.1 (>= 3.1.28), dotnet-runtime-deps-3.1 (>= 3.1.29), dotnet-runtime-deps-3.1 (>= 3.1.30), dotnet-runtime-deps-3.1 (>= 3.1.31), dotnet-runtime-deps-3.1 (>= 3.1.32)
...
- **dotnet-runtime-8.0**
  ...
  - Section: libs
  - Priority: standard
  - depends: dotnet-hostfxr-8.0 (>= 8.0.0), dotnet-hostfxr-8.0 (>= 8.0.1), dotnet-hostfxr-8.0 (>= 8.0.10), dotnet-hostfxr-8.0 (>= 8.0.11), dotnet-hostfxr-8.0 (>= 8.0.12), dotnet-hostfxr-8.0 (>= 8.0.2), dotnet-hostfxr-8.0 (>= 8.0.3), dotnet-hostfxr-8.0 (>= 8.0.4), dotnet-hostfxr-8.0 (>= 8.0.5), dotnet-hostfxr-8.0 (>= 8.0.6), dotnet-hostfxr-8.0 (>= 8.0.7), dotnet-hostfxr-8.0 (>= 8.0.8), dotnet-runtime-deps-8.0 (>= 8.0.0), dotnet-runtime-deps-8.0 (>= 8.0.1), dotnet-runtime-deps-8.0 (>= 8.0.10), dotnet-runtime-deps-8.0 (>= 8.0.11), dotnet-runtime-deps-8.0 (>= 8.0.12), dotnet-runtime-deps-8.0 (>= 8.0.2), dotnet-runtime-deps-8.0 (>= 8.0.3), dotnet-runtime-deps-8.0 (>= 8.0.4), dotnet-runtime-deps-8.0 (>= 8.0.5), dotnet-runtime-deps-8.0 (>= 8.0.6), dotnet-runtime-deps-8.0 (>= 8.0.7), dotnet-runtime-deps-8.0 (>= 8.0.8)
...
- **dotnet-runtime-9.0**
  ...
  - Section: libs
  - Priority: standard
  - depends: dotnet-hostfxr-9.0 (>= 9.0.1), dotnet-runtime-deps-9.0 (>= 9.0.1)
...
- **dotnet-runtime-deps-3.1**
  ...
  - Suite: bullseye
  - Components: main
  - Description: dotnet-runtime-deps-3.1 3.1.19
  - Homepage: https://dot.net/core
...
- **dotnet-sdk-2.1**
  ...
  - Section: devel
  - Priority: standard
  - depends: aspnetcore-runtime-2.1 (>= 2.1.30), dotnet-runtime-2.1 (>= 2.1.30), libc6 (>= 2.4), libgcc1 (>= 1:3.0), libstdc++6 (>= 4.8)
...
- **dotnet-sdk-3.1**
  ...
  - Suite: bullseye
  - Components: main
  - Description: Microsoft .NET Core SDK 3.1.417
  - Homepage: https://dotnet.github.io/core
  ...
  - Section: devel
  - Priority: standard
  - depends: aspnetcore-runtime-3.1 (>= 3.1.18), aspnetcore-runtime-3.1 (>= 3.1.19), aspnetcore-runtime-3.1 (>= 3.1.20), aspnetcore-runtime-3.1 (>= 3.1.21), aspnetcore-runtime-3.1 (>= 3.1.22), aspnetcore-runtime-3.1 (>= 3.1.23), aspnetcore-runtime-3.1 (>= 3.1.24), aspnetcore-runtime-3.1 (>= 3.1.25), aspnetcore-runtime-3.1 (>= 3.1.26), aspnetcore-runtime-3.1 (>= 3.1.27), aspnetcore-runtime-3.1 (>= 3.1.28), aspnetcore-runtime-3.1 (>= 3.1.29), aspnetcore-runtime-3.1 (>= 3.1.30), aspnetcore-runtime-3.1 (>= 3.1.31), aspnetcore-runtime-3.1 (>= 3.1.32), aspnetcore-targeting-pack-3.1 (>= 3.1.10), dotnet-apphost-pack-3.1 (>= 3.1.18), dotnet-apphost-pack-3.1 (>= 3.1.19), dotnet-apphost-pack-3.1 (>= 3.1.20), dotnet-apphost-pack-3.1 (>= 3.1.21), dotnet-apphost-pack-3.1 (>= 3.1.22), dotnet-apphost-pack-3.1 (>= 3.1.23), dotnet-apphost-pack-3.1 (>= 3.1.24), dotnet-apphost-pack-3.1 (>= 3.1.25), dotnet-apphost-pack-3.1 (>= 3.1.26), dotnet-apphost-pack-3.1 (>= 3.1.27), dotnet-apphost-pack-3.1 (>= 3.1.28), dotnet-apphost-pack-3.1 (>= 3.1.29), dotnet-apphost-pack-3.1 (>= 3.1.30), dotnet-apphost-pack-3.1 (>= 3.1.31), dotnet-apphost-pack-3.1 (>= 3.1.32), dotnet-runtime-3.1 (>= 3.1.18), dotnet-runtime-3.1 (>= 3.1.19), dotnet-runtime-3.1 (>= 3.1.20), dotnet-runtime-3.1 (>= 3.1.21), dotnet-runtime-3.1 (>= 3.1.22), dotnet-runtime-3.1 (>= 3.1.23), dotnet-runtime-3.1 (>= 3.1.24), dotnet-runtime-3.1 (>= 3.1.25), dotnet-runtime-3.1 (>= 3.1.26), dotnet-runtime-3.1 (>= 3.1.27), dotnet-runtime-3.1 (>= 3.1.28), dotnet-runtime-3.1 (>= 3.1.29), dotnet-runtime-3.1 (>= 3.1.30), dotnet-runtime-3.1 (>= 3.1.31), dotnet-runtime-3.1 (>= 3.1.32), dotnet-targeting-pack-3.1 (>= 3.1.0), libc6 (>= 2.14), libgcc1 (>= 1:3.0), libstdc++6 (>= 4.6), netstandard-targeting-pack-2.1 (>= 2.1.0)
...
- **dotnet-sdk-5.0**
  ...
  - Suite: bullseye
  - Components: main
  - Description: Microsoft .NET SDK 5.0.403
  - Homepage: https://dotnet.github.io/core
...
- **dotnet-sdk-8.0**
  ...
  - Section: devel
  - Priority: standard
  - depends: aspnetcore-runtime-8.0 (>= 8.0.0), aspnetcore-runtime-8.0 (>= 8.0.1), aspnetcore-runtime-8.0 (>= 8.0.10), aspnetcore-runtime-8.0 (>= 8.0.11), aspnetcore-runtime-8.0 (>= 8.0.12), aspnetcore-runtime-8.0 (>= 8.0.2), aspnetcore-runtime-8.0 (>= 8.0.3), aspnetcore-runtime-8.0 (>= 8.0.4), aspnetcore-runtime-8.0 (>= 8.0.5), aspnetcore-runtime-8.0 (>= 8.0.6), aspnetcore-runtime-8.0 (>= 8.0.7), aspnetcore-runtime-8.0 (>= 8.0.8), aspnetcore-targeting-pack-8.0 (>= 8.0.0), aspnetcore-targeting-pack-8.0 (>= 8.0.1), aspnetcore-targeting-pack-8.0 (>= 8.0.10), aspnetcore-targeting-pack-8.0 (>= 8.0.11), aspnetcore-targeting-pack-8.0 (>= 8.0.12), aspnetcore-targeting-pack-8.0 (>= 8.0.2), aspnetcore-targeting-pack-8.0 (>= 8.0.3), aspnetcore-targeting-pack-8.0 (>= 8.0.4), aspnetcore-targeting-pack-8.0 (>= 8.0.5), aspnetcore-targeting-pack-8.0 (>= 8.0.6), aspnetcore-targeting-pack-8.0 (>= 8.0.7), aspnetcore-targeting-pack-8.0 (>= 8.0.8), dotnet-apphost-pack-8.0 (>= 8.0.0), dotnet-apphost-pack-8.0 (>= 8.0.1), dotnet-apphost-pack-8.0 (>= 8.0.10), dotnet-apphost-pack-8.0 (>= 8.0.11), dotnet-apphost-pack-8.0 (>= 8.0.12), dotnet-apphost-pack-8.0 (>= 8.0.2), dotnet-apphost-pack-8.0 (>= 8.0.3), dotnet-apphost-pack-8.0 (>= 8.0.4), dotnet-apphost-pack-8.0 (>= 8.0.5), dotnet-apphost-pack-8.0 (>= 8.0.6), dotnet-apphost-pack-8.0 (>= 8.0.7), dotnet-apphost-pack-8.0 (>= 8.0.8), dotnet-runtime-8.0 (>= 8.0.0), dotnet-runtime-8.0 (>= 8.0.1), dotnet-runtime-8.0 (>= 8.0.10), dotnet-runtime-8.0 (>= 8.0.11), dotnet-runtime-8.0 (>= 8.0.12), dotnet-runtime-8.0 (>= 8.0.2), dotnet-runtime-8.0 (>= 8.0.3), dotnet-runtime-8.0 (>= 8.0.4), dotnet-runtime-8.0 (>= 8.0.5), dotnet-runtime-8.0 (>= 8.0.6), dotnet-runtime-8.0 (>= 8.0.7), dotnet-runtime-8.0 (>= 8.0.8), dotnet-targeting-pack-8.0 (>= 8.0.0), dotnet-targeting-pack-8.0 (>= 8.0.1), dotnet-targeting-pack-8.0 (>= 8.0.10), dotnet-targeting-pack-8.0 (>= 8.0.11), dotnet-targeting-pack-8.0 (>= 8.0.12), dotnet-targeting-pack-8.0 (>= 8.0.2), dotnet-targeting-pack-8.0 (>= 8.0.3), dotnet-targeting-pack-8.0 (>= 8.0.4), dotnet-targeting-pack-8.0 (>= 8.0.5), dotnet-targeting-pack-8.0 (>= 8.0.6), dotnet-targeting-pack-8.0 (>= 8.0.7), dotnet-targeting-pack-8.0 (>= 8.0.8), netstandard-targeting-pack-2.1 (>= 2.1.0)

  </details>

- **dotnet-sdk-9.0**
  - Latest version: 9.0.102-1
  - Architectures: amd64
  - Suite: bullseye
  - Components: main
  ...
  - Section: devel
  - Priority: standard
  - depends: aspnetcore-runtime-9.0 (>= 9.0.1), aspnetcore-targeting-pack-9.0 (>= 9.0.1), dotnet-apphost-pack-9.0 (>= 9.0.1), dotnet-runtime-9.0 (>= 9.0.1), dotnet-targeting-pack-9.0 (>= 9.0.1), netstandard-targeting-pack-2.1 (>= 2.1.0)
...
- **iotedge**
  ...
  - Section: admin
  - Priority: extra
  - depends: adduser, ca-certificates, hostname, libc6 (>= 2.28), libgcc-s1 (>= 4.3), libiothsm-std (= 1.1.13-1), libiothsm-std (= 1.1.15-1), libssl1.1 (>= 1.1.0), sed
...
- **libdeliveryoptimization**
  ...
  - Section: devel
  - Priority: optional
  - depends: deliveryoptimization-agent, libc6 (>= 2.17), libc6 (>= 2.28), libc6 (>= 2.9), libgcc-s1 (>= 3.0), libgcc-s1 (>= 3.5), libstdc++6 (>= 9)
...
- **moby-buildx**
  - Latest version: 0.30.1-debian11u1
  - Architectures: amd64, arm64, armhf
  - Suite: bullseye
  - Components: main
  ...
  - Section: admin
  - Priority: optional
  - depends: libc6 (>= 2.17), libc6 (>= 2.3.2), libc6 (>= 2.4), libssl1.1
  - recommends: moby-cli
...
- **moby-buildx-dbgsym**
  ...
  - Section: debug
  - Priority: optional
  - depends: moby-buildx (= 0.30.0-debian11u1), moby-buildx (= 0.30.1-debian11u1)

  </details>

- **moby-cli**
  - Latest version: 29.1.4-debian11u1
  - Architectures: amd64, arm64, armhf
  - Suite: bullseye
  - Components: main
...
- **moby-cli-dbgsym**
  ...
  - Section: debug
  - Priority: optional
  - depends: moby-cli (= 29.1.2-debian11u1), moby-cli (= 29.1.2-debian11u2), moby-cli (= 29.1.3-debian11u1), moby-cli (= 29.1.4-debian11u1)

  </details>

- **moby-compose**
  - Latest version: 5.0.1-debian11u1
  - Architectures: amd64, arm64, armhf
  - Suite: bullseye
  - Components: main
...
- **moby-compose-dbgsym**
  ...
  - Section: debug
  - Priority: optional
  - depends: moby-compose (= 5.0.0-debian11u1), moby-compose (= 5.0.1-debian11u1)

  </details>

- **moby-containerd**
  - Latest version: 2.2.1-debian11u1
  - Architectures: amd64, arm64, armhf
  - Suite: bullseye
  - Components: main
  ...
  - Section: admin
  - Priority: optional
  - depends: libc6 (>= 2.17), libc6 (>= 2.3.2), libc6 (>= 2.4), moby-runc (>= 1.0.0~rc10), moby-runc (>= 1.0.2), moby-runc (>= 1.1.0)
...
- **moby-containerd-shim-systemd**
  - Latest version: 0.1.0~beta.1+azure-debian11u1
  - Architectures: amd64, arm64, armhf
  - Suite: bullseye
  - Components: main
...
- **moby-engine**
  - Latest version: 29.1.4-debian11u2
  - Architectures: amd64, arm64, armhf
  - Suite: bullseye
  - Components: main
  ...
  - Section: admin
  - Priority: optional
  - depends: iptables, libc6 (>= 2.14), libc6 (>= 2.17), libc6 (>= 2.3.2), libc6 (>= 2.4), libdevmapper1.02.1 (>= 2:1.02.97), libnftables1 (>= 0.9.8), libsystemd0, moby-containerd (>= 1.4.3), moby-containerd (>= 1.7.0), moby-runc (>= 1.0.0~rc93), moby-runc (>= 1.0.2), moby-runc (>= 1.1.0), moby-tini (>= 0.19.0), nftables
...
- **moby-engine-dbgsym**
  ...
  - Section: debug
  - Priority: optional
  - depends: moby-engine (= 29.1.3-debian11u1), moby-engine (= 29.1.4-debian11u1), moby-engine (= 29.1.4-debian11u2)

  </details>

- **moby-runc**
  - Latest version: 1.2.8-debian11u2
  - Architectures: amd64, arm64, armhf
  - Suite: bullseye
  - Components: main
...
- **moby-runc-dbgsym**
  ...
  - Section: debug
  - Priority: optional
  - depends: moby-runc (= 1.2.7-debian11u1), moby-runc (= 1.2.8-debian11u1), moby-runc (= 1.2.8-debian11u2)

  </details>

- **moby-tini**
  - Latest version: 0.19.0-debian11u2
  - Architectures: amd64, arm64, armhf
  - Suite: bullseye
  - Components: main
...
- **msft-golang**
  - Latest version: 1.25.6-debian11u1
  - Architectures: amd64, arm64
  - Suite: bullseye
  - Components: main
...
- **msft-golang-dbgsym**
  ...
  - Section: debug
  - Priority: optional
  - depends: msft-golang (= 1.24.0-debian11u1), msft-golang (= 1.24.1-debian11u1), msft-golang (= 1.24.10-debian11u1), msft-golang (= 1.24.11-debian11u1), msft-golang (= 1.24.12-debian11u1), msft-golang (= 1.24.2-debian11u1), msft-golang (= 1.24.4-debian11u1), msft-golang (= 1.24.5-debian11u1), msft-golang (= 1.24.6-debian11u1), msft-golang (= 1.24.7-debian11u1), msft-golang (= 1.24.9-debian11u1), msft-golang (= 1.25.1-debian11u1), msft-golang (= 1.25.3-debian11u1), msft-golang (= 1.25.4-debian11u1), msft-golang (= 1.25.5-debian11u1), msft-golang (= 1.25.6-debian11u1)
...
- **odbcinst**
  ...
  - Section: libs
  - Priority: optional
  - depends: libc6 (>= 2.4), odbcinst1debian2 (>= 2.3.11-1), odbcinst1debian2 (>= 2.3.11-2), odbcinst1debian2 (>= 2.3.11-3), odbcinst1debian2 (>= 2.3.11), odbcinst1debian2 (>= 2.3.7)
  - conflicts: odbcinst1
...
- **odbcinst1debian2**
  ...
  - Section: libs
  - Priority: optional
  - depends: libc6 (>= 2.14), libltdl7 (>= 2.4.2), odbcinst (>= 2.3.11-1), odbcinst (>= 2.3.11-2), odbcinst (>= 2.3.11-3), odbcinst (>= 2.3.11), odbcinst (>= 2.3.7)
...
- **powershell**
  ...
  - Section: shells
  - Priority: extra
  - depends: libc6, libgcc1, libgssapi-krb5-2, libicu72|libicu71|libicu70|libicu69|libicu68|libicu67|libicu66|libicu65|libicu63|libicu60|libicu57|libicu55|libicu52, libicu74|libicu72|libicu71|libicu70|libicu69|libicu68|libicu67|libicu66|libicu65|libicu63|libicu60|libicu57|libicu55|libicu52, libssl1.1|libssl1.0.2|libssl1.0.0, libssl3|libssl1.1|libssl1.0.2|libssl1.0.0, libstdc++6, zlib1g
...
- **powershell-preview**
  ...
  - Section: shells
  - Priority: extra
  - depends: libc6, libgcc1, libgssapi-krb5-2, libicu72|libicu71|libicu70|libicu69|libicu68|libicu67|libicu66|libicu65|libicu63|libicu60|libicu57|libicu55|libicu52, libicu74|libicu72|libicu71|libicu70|libicu69|libicu68|libicu67|libicu66|libicu65|libicu63|libicu60|libicu57|libicu55|libicu52, libicu76|libicu74|libicu72|libicu71|libicu70|libicu69|libicu68|libicu67|libicu66|libicu65|libicu63|libicu60|libicu57|libicu55|libicu52, libssl1.1|libssl1.0.2|libssl1.0.0, libssl3|libssl1.1|libssl1.0.2|libssl1.0.0, libstdc++6, zlib1g
...
- **unixodbc**
  ...
  - Section: database
  - Priority: optional
  - depends: libc6 (>= 2.14), libodbc1 (>= 2.3.11-1), libodbc1 (>= 2.3.11-2), libodbc1 (>= 2.3.11-3), libodbc1 (>= 2.3.11), libodbc1 (>= 2.3.7), odbcinst1debian2 (>= 2.3.11-1), odbcinst1debian2 (>= 2.3.11-2), odbcinst1debian2 (>= 2.3.11-3), odbcinst1debian2 (>= 2.3.11), odbcinst1debian2 (>= 2.3.7)
...
- **unixodbc-dev**
  ...
  - Section: devel
  - Priority: extra
  - depends: libltdl3-dev, odbcinst1debian2 (= 2.3.11-1), odbcinst1debian2 (= 2.3.11-2), odbcinst1debian2 (= 2.3.11-3), odbcinst1debian2 (= 2.3.11), odbcinst1debian2 (= 2.3.7), unixodbc (= 2.3.11-1), unixodbc (= 2.3.11-2), unixodbc (= 2.3.11-3), unixodbc (= 2.3.11), unixodbc (= 2.3.7)
