# Pop!_OS staging-proprietary - 24.04 (popos-24.04)

## Repository
- Repository ID: `popos-staging-proprietary-24.04`
- OS: `popos-24.04`
- Source: `http://apt.pop-os.org/staging-proprietary noble main`
...
echo "deb [signed-by=/usr/share/keyrings/popos-lookup-204dd8aec33a7aff.gpg] http://apt.pop-os.org/staging-proprietary noble main" | sudo tee /etc/apt/sources.list.d/popos-staging-proprietary-24.04.list >/dev/null
sudo apt-get update
```
