# Pop!_OS release-ubuntu - 22.04 (popos-22.04)

## Repository
- Repository ID: `popos-release-ubuntu-22.04`
- OS: `popos-22.04`
- Source: `http://apt.pop-os.org/release-ubuntu jammy main`
...
echo "deb [signed-by=/usr/share/keyrings/popos-lookup-204dd8aec33a7aff.gpg] http://apt.pop-os.org/release-ubuntu jammy main" | sudo tee /etc/apt/sources.list.d/popos-release-ubuntu-22.04.list >/dev/null
sudo apt-get update
```
