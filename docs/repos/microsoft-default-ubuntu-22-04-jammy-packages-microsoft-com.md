# Microsoft - ubuntu-22.04 - default (ubuntu-22.04)

## Repository
- Repository ID: `microsoft-default-ubuntu-22-04-jammy-packages-microsoft-com`
- OS: `ubuntu-22.04`
- Source: `[arch=amd64,arm64,armhf] https://packages.microsoft.com/ubuntu/22.04/prod jammy main`
...
echo "deb [signed-by=/usr/share/keyrings/microsoft-microsoft-eb3e94adbe1229cf.gpg] [arch=amd64,arm64,armhf] https://packages.microsoft.com/ubuntu/22.04/prod jammy main" | sudo tee /etc/apt/sources.list.d/microsoft-default-ubuntu-22-04-jammy-packages-microsoft-com.list >/dev/null
sudo apt-get update
```
