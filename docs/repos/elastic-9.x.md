# Elastic 9.x (Stable) (ubuntu-22.04)

## Repository
- Repository ID: `elastic-9.x`
- OS: `ubuntu-22.04`
- Source: `https://artifacts.elastic.co/packages/9.x/apt stable main`
...
echo "deb [signed-by=/usr/share/keyrings/elasticsearch.gpg] https://artifacts.elastic.co/packages/9.x/apt stable main" | sudo tee /etc/apt/sources.list.d/elastic-9.x.list >/dev/null
sudo apt-get update
```
