# Pop!_OS staging (master) - 24.04 (popos-24.04)

## Repository
- Repository ID: `popos-staging-master-24.04`
- OS: `popos-24.04`
- Source: `[arch=amd64] http://apt.pop-os.org/staging/master noble main`
...
echo "deb [signed-by=/usr/share/keyrings/popos-lookup-204dd8aec33a7aff.gpg] [arch=amd64] http://apt.pop-os.org/staging/master noble main" | sudo tee /etc/apt/sources.list.d/popos-staging-master-24.04.list >/dev/null
sudo apt-get update
```
