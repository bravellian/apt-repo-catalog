# Docker - Ubuntu (Zesty) - stable (ubuntu-17.04)

## Repository
- Repository ID: `docker-ubuntu-zesty-stable`
- OS: `ubuntu-17.04`
- Source: `https://download.docker.com/linux/ubuntu zesty stable`
...
echo "deb [signed-by=/usr/share/keyrings/docker-gpg-8d81803c0ebfcd88.gpg] https://download.docker.com/linux/ubuntu zesty stable" | sudo tee /etc/apt/sources.list.d/docker-ubuntu-zesty-stable.list >/dev/null
sudo apt-get update
```
