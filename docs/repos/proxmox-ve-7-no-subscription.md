# Proxmox VE 7 - no-subscription (proxmox-7)

## Repository
- Repository ID: `proxmox-ve-7-no-subscription`
- OS: `proxmox-7`
- Source: `http://download.proxmox.com/debian/pve bullseye pve-no-subscription`
...
echo "deb [signed-by=/usr/share/keyrings/proxmox-release-bullseye.gpg] http://download.proxmox.com/debian/pve bullseye pve-no-subscription" | sudo tee /etc/apt/sources.list.d/proxmox-ve-7-no-subscription.list >/dev/null
sudo apt-get update
```
