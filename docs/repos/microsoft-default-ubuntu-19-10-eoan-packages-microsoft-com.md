# Microsoft - ubuntu-19.10 - default (ubuntu-19.10)

## Repository
- Repository ID: `microsoft-default-ubuntu-19-10-eoan-packages-microsoft-com`
- OS: `ubuntu-19.10`
- Source: `[arch=amd64,arm64,armhf] https://packages.microsoft.com/ubuntu/19.10/prod eoan main`
...
echo "deb [signed-by=/usr/share/keyrings/microsoft-microsoft-eb3e94adbe1229cf.gpg] [arch=amd64,arm64,armhf] https://packages.microsoft.com/ubuntu/19.10/prod eoan main" | sudo tee /etc/apt/sources.list.d/microsoft-default-ubuntu-19-10-eoan-packages-microsoft-com.list >/dev/null
sudo apt-get update
```
