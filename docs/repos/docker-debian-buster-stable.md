# Docker - Debian (Buster) - stable (debian-10)

## Repository
- Repository ID: `docker-debian-buster-stable`
- OS: `debian-10`
- Source: `https://download.docker.com/linux/debian buster stable`
...
echo "deb [signed-by=/usr/share/keyrings/docker-gpg-8d81803c0ebfcd88.gpg] https://download.docker.com/linux/debian buster stable" | sudo tee /etc/apt/sources.list.d/docker-debian-buster-stable.list >/dev/null
sudo apt-get update
```
...
- **docker-ce**
  ...
  - Section: admin
  - Priority: optional
  - depends: containerd.io, containerd.io (>= 1.2.2-3), containerd.io (>= 1.4.1), containerd.io (>= 1.6.24), containerd.io (>= 1.6.4), docker-ce-cli, iptables, libapparmor1 (>= 2.6~devel), libc6 (>= 2.14), libc6 (>= 2.17), libc6 (>= 2.3.2), libdevmapper1.02.1 (>= 2:1.02.97), libltdl7 (>= 2.4.6), libseccomp2 (>= 2.3.0), libsystemd0
...
- **docker-ce-rootless-extras**
  ...
  - Section: admin
  - Priority: optional
  - depends: dbus-user-session, docker-ce, libc6 (>= 2.3.2)
