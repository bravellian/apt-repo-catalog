# Microsoft - ubuntu-25.10 - default

## Repository
- Repository ID: `microsoft-default-ubuntu-25-10-questing-packages-microsoft-com`
- Base URL: `https://packages.microsoft.com/ubuntu/25.10/prod`
...
echo "deb [arch=amd64,arm64,armhf signed-by=/usr/share/keyrings/microsoft-microsoft-eb3e94adbe1229cf.gpg] https://packages.microsoft.com/ubuntu/25.10/prod questing main" | sudo tee /etc/apt/sources.list.d/microsoft-default-ubuntu-25-10-questing-packages-microsoft-com-questing.list >/dev/null
sudo apt-get update
```
