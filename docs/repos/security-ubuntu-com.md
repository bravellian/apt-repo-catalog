...
## Repository
- Repository ID: `security-ubuntu-com`
- Base URL: `https://security.ubuntu.com/ubuntu`
...
echo "deb [signed-by=/usr/share/keyrings/ubuntu-archive-ubuntu-com-signing-key-871920d1991bc93c.gpg] https://security.ubuntu.com/ubuntu jammy-security main multiverse restricted universe" | sudo tee /etc/apt/sources.list.d/security-ubuntu-com-jammy-security.list >/dev/null
sudo apt-get update
```
