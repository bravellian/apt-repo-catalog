# Docker - Debian (Bookworm) - stable (debian-12)

## Repository
- Repository ID: `docker-debian-bookworm-stable`
- OS: `debian-12`
- Source: `https://download.docker.com/linux/debian bookworm stable`
...
echo "deb [signed-by=/usr/share/keyrings/docker-gpg-8d81803c0ebfcd88.gpg] https://download.docker.com/linux/debian bookworm stable" | sudo tee /etc/apt/sources.list.d/docker-debian-bookworm-stable.list >/dev/null
sudo apt-get update
```
...
- **containerd.io-dbgsym**
  ...
  - Section: debug
  - Priority: optional
  - depends: containerd.io (= 1.7.28-0~debian.12~bookworm), containerd.io (= 1.7.28-1~debian.12~bookworm), containerd.io (= 1.7.28-2~debian.12~bookworm), containerd.io (= 1.7.29-1~debian.12~bookworm), containerd.io (= 2.1.5-1~debian.12~bookworm), containerd.io (= 2.2.0-2~debian.12~bookworm), containerd.io (= 2.2.1-1~debian.12~bookworm)
...
- **docker-model-plugin**
  - Latest version: 1.0.7-1~debian.12~bookworm
  - Architectures: amd64
  - Suite: bookworm
  - Components: stable
