# Microsoft - ubuntu-19.04 - default (ubuntu-19.04)

Repository ID: `microsoft-default-ubuntu-19-04-disco-packages-microsoft-com`
OS: `ubuntu-19.04`
Source: `[arch=amd64] https://packages.microsoft.com/ubuntu/19.04/prod disco main`
...
echo "deb [signed-by=/usr/share/keyrings/microsoft-microsoft-eb3e94adbe1229cf.gpg] [arch=amd64] https://packages.microsoft.com/ubuntu/19.04/prod disco main" | sudo tee /etc/apt/sources.list.d/microsoft-default-ubuntu-19-04-disco-packages-microsoft-com.list >/dev/null
sudo apt-get update
```
