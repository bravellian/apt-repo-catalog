# Docker - Ubuntu (Disco) - stable (ubuntu-19.04)

## Repository
- Repository ID: `docker-ubuntu-disco-stable`
- OS: `ubuntu-19.04`
- Source: `https://download.docker.com/linux/ubuntu disco stable`
...
echo "deb [signed-by=/usr/share/keyrings/docker-gpg-8d81803c0ebfcd88.gpg] https://download.docker.com/linux/ubuntu disco stable" | sudo tee /etc/apt/sources.list.d/docker-ubuntu-disco-stable.list >/dev/null
sudo apt-get update
```
...
- **containerd.io**
  ...
  - Section: devel
  - Priority: optional
  - depends: libc6 (>= 2.14), libc6 (>= 2.17), libseccomp2 (>= 2.3.0), libseccomp2 (>= 2.4.0)
