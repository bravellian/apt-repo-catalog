# Docker - Ubuntu (Mantic) - stable (ubuntu-23.10)

Repository ID: `docker-ubuntu-mantic-stable`
OS: `ubuntu-23.10`
Source: `https://download.docker.com/linux/ubuntu mantic stable`
...
echo "deb [signed-by=/usr/share/keyrings/docker-gpg-8d81803c0ebfcd88.gpg] https://download.docker.com/linux/ubuntu mantic stable" | sudo tee /etc/apt/sources.list.d/docker-ubuntu-mantic-stable.list >/dev/null
sudo apt-get update
```
