# Microsoft - ubuntu-22.10 - default (ubuntu-22.10)

## Repository
- Repository ID: `microsoft-default-ubuntu-22-10-kinetic-packages-microsoft-com`
- OS: `ubuntu-22.10`
- Source: `[arch=amd64,armhf,arm64] https://packages.microsoft.com/ubuntu/22.10/prod kinetic main`
...
echo "deb [signed-by=/usr/share/keyrings/microsoft-microsoft-eb3e94adbe1229cf.gpg] [arch=amd64,armhf,arm64] https://packages.microsoft.com/ubuntu/22.10/prod kinetic main" | sudo tee /etc/apt/sources.list.d/microsoft-default-ubuntu-22-10-kinetic-packages-microsoft-com.list >/dev/null
sudo apt-get update
```
