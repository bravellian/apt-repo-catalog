# Docker - Ubuntu (Yakkety) - stable (ubuntu-16.10)

## Repository
- Repository ID: `docker-ubuntu-yakkety-stable`
- OS: `ubuntu-16.10`
- Source: `https://download.docker.com/linux/ubuntu yakkety stable`
...
echo "deb [signed-by=/usr/share/keyrings/docker-gpg-8d81803c0ebfcd88.gpg] https://download.docker.com/linux/ubuntu yakkety stable" | sudo tee /etc/apt/sources.list.d/docker-ubuntu-yakkety-stable.list >/dev/null
sudo apt-get update
```
