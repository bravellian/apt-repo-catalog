# Docker - Ubuntu (Lunar) - stable (ubuntu-23.04)

Repository ID: `docker-ubuntu-lunar-stable`
OS: `ubuntu-23.04`
Source: `https://download.docker.com/linux/ubuntu lunar stable`
...
echo "deb [signed-by=/usr/share/keyrings/docker-gpg-8d81803c0ebfcd88.gpg] https://download.docker.com/linux/ubuntu lunar stable" | sudo tee /etc/apt/sources.list.d/docker-ubuntu-lunar-stable.list >/dev/null
sudo apt-get update
```
