# Microsoft - ubuntu-25.04 - default (ubuntu-25.04)

## Repository
- Repository ID: `microsoft-default-ubuntu-25-04-plucky-packages-microsoft-com`
- OS: `ubuntu-25.04`
- Source: `[arch=amd64,arm64,armhf signed-by=/usr/share/keyrings/microsoft-prod.gpg] https://packages.microsoft.com/ubuntu/25.04/prod plucky main`

## Upstream documentation
- Documentation URL: https://packages.microsoft.com/config/ubuntu/25.04
...
echo "deb [signed-by=/usr/share/keyrings/microsoft-microsoft-eb3e94adbe1229cf.gpg] [arch=amd64,arm64,armhf signed-by=/usr/share/keyrings/microsoft-prod.gpg] https://packages.microsoft.com/ubuntu/25.04/prod plucky main" | sudo tee /etc/apt/sources.list.d/microsoft-default-ubuntu-25-04-plucky-packages-microsoft-com.list >/dev/null
sudo apt-get update
```
...
<a href="#packages-A">A</a> <a href="#packages-L">L</a> <a href="#packages-M">M</a> <a href="#packages-P">P</a>
</div>
...
- **mdatp**
  ...
  - Section: devel
  - Priority: optional
  - depends: libc6 (>= 2.23), uuid-runtime
...
- **packages-microsoft-prod**
  - Latest version: 1.1-ubuntu25.04
  - Architectures: all
  - Suite: plucky
  - Components: main
