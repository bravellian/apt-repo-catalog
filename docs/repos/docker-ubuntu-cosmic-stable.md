# Docker - Ubuntu (Cosmic) - stable (ubuntu-18.10)

## Repository
- Repository ID: `docker-ubuntu-cosmic-stable`
- OS: `ubuntu-18.10`
- Source: `https://download.docker.com/linux/ubuntu cosmic stable`
...
echo "deb [signed-by=/usr/share/keyrings/docker-gpg-8d81803c0ebfcd88.gpg] https://download.docker.com/linux/ubuntu cosmic stable" | sudo tee /etc/apt/sources.list.d/docker-ubuntu-cosmic-stable.list >/dev/null
sudo apt-get update
```
...
- **docker-ce**
  ...
  - Section: admin
  - Priority: optional
  - depends: containerd.io, containerd.io (>= 1.2.2-3), docker-ce-cli, iptables, libc6 (>= 2.17), libc6 (>= 2.3.2), libc6 (>= 2.8), libdevmapper1.02.1 (>= 2:1.02.97), libseccomp2 (>= 2.3.0), libsystemd0
