# Docker - Ubuntu (Plucky) - stable (ubuntu-25.04)

## Repository
- Repository ID: `docker-ubuntu-plucky-stable`
- OS: `ubuntu-25.04`
- Source: `https://download.docker.com/linux/ubuntu plucky stable`
...
echo "deb [signed-by=/usr/share/keyrings/docker-gpg-8d81803c0ebfcd88.gpg] https://download.docker.com/linux/ubuntu plucky stable" | sudo tee /etc/apt/sources.list.d/docker-ubuntu-plucky-stable.list >/dev/null
sudo apt-get update
```
...
- **docker-model-plugin**
  - Latest version: 1.0.7-1~ubuntu.25.04~plucky
  - Architectures: amd64
  - Suite: plucky
  - Components: stable
