# Microsoft - ubuntu-21.04 - default (ubuntu-21.04)

Repository ID: `microsoft-default-ubuntu-21-04-hirsute-packages-microsoft-com`
OS: `ubuntu-21.04`
Source: `[arch=amd64,armhf,arm64] https://packages.microsoft.com/ubuntu/21.04/prod hirsute main`
...
echo "deb [signed-by=/usr/share/keyrings/microsoft-microsoft-eb3e94adbe1229cf.gpg] [arch=amd64,armhf,arm64] https://packages.microsoft.com/ubuntu/21.04/prod hirsute main" | sudo tee /etc/apt/sources.list.d/microsoft-default-ubuntu-21-04-hirsute-packages-microsoft-com.list >/dev/null
sudo apt-get update
```
