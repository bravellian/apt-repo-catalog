# Microsoft - ubuntu-24.04 - default (ubuntu-24.04)

Repository ID: `microsoft-default-ubuntu-24-04-noble-packages-microsoft-com`
OS: `ubuntu-24.04`
Source: `[arch=amd64,arm64,armhf signed-by=/usr/share/keyrings/microsoft-prod.gpg] https://packages.microsoft.com/ubuntu/24.04/prod noble main`
...
echo "deb [signed-by=/usr/share/keyrings/microsoft-microsoft-eb3e94adbe1229cf.gpg] [arch=amd64,arm64,armhf signed-by=/usr/share/keyrings/microsoft-prod.gpg] https://packages.microsoft.com/ubuntu/24.04/prod noble main" | sudo tee /etc/apt/sources.list.d/microsoft-default-ubuntu-24-04-noble-packages-microsoft-com.list >/dev/null
sudo apt-get update
```
