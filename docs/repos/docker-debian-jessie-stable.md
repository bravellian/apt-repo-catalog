# Docker - Debian (Jessie) - stable (debian-8)

## Repository
- Repository ID: `docker-debian-jessie-stable`
- OS: `debian-8`
- Source: `https://download.docker.com/linux/debian jessie stable`
...
echo "deb [signed-by=/usr/share/keyrings/docker-gpg-8d81803c0ebfcd88.gpg] https://download.docker.com/linux/debian jessie stable" | sudo tee /etc/apt/sources.list.d/docker-debian-jessie-stable.list >/dev/null
sudo apt-get update
```
...
- **docker-ce**
  ...
  - Section: admin
  - Priority: optional
  - depends: init-system-helpers (>= 1.18~), iptables, libapparmor1 (>= 2.6~devel), libc6 (>= 2.17), libdevmapper1.02.1 (>= 2:1.02.90), libltdl7 (>= 2.4.2), libsystemd0
