# Docker - Ubuntu (Oracular) - stable (ubuntu-24.10)

## Repository
- Repository ID: `docker-ubuntu-oracular-stable`
- OS: `ubuntu-24.10`
- Source: `https://download.docker.com/linux/ubuntu oracular stable`
...
echo "deb [signed-by=/usr/share/keyrings/docker-gpg-8d81803c0ebfcd88.gpg] https://download.docker.com/linux/ubuntu oracular stable" | sudo tee /etc/apt/sources.list.d/docker-ubuntu-oracular-stable.list >/dev/null
sudo apt-get update
```
