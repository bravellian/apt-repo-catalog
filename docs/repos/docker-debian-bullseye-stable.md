# Docker - Debian (Bullseye) - stable (debian-11)

Repository ID: `docker-debian-bullseye-stable`
OS: `debian-11`
Source: `https://download.docker.com/linux/debian bullseye stable`
...
echo "deb [signed-by=/usr/share/keyrings/docker-gpg-8d81803c0ebfcd88.gpg] https://download.docker.com/linux/debian bullseye stable" | sudo tee /etc/apt/sources.list.d/docker-debian-bullseye-stable.list >/dev/null
sudo apt-get update
```
