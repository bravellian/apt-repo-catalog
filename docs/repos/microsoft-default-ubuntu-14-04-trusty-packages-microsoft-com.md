# Microsoft - ubuntu-14.04 - default (ubuntu-14.04)

## Repository
- Repository ID: `microsoft-default-ubuntu-14-04-trusty-packages-microsoft-com`
- OS: `ubuntu-14.04`
- Source: `[arch=amd64] https://packages.microsoft.com/ubuntu/14.04/prod trusty main`
...
echo "deb [signed-by=/usr/share/keyrings/microsoft-microsoft-eb3e94adbe1229cf.gpg] [arch=amd64] https://packages.microsoft.com/ubuntu/14.04/prod trusty main" | sudo tee /etc/apt/sources.list.d/microsoft-default-ubuntu-14-04-trusty-packages-microsoft-com.list >/dev/null
sudo apt-get update
```
