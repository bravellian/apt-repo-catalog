...
- **containerd.io-dbgsym**
  ...
  - Section: debug
  - Priority: optional
  - depends: containerd.io (= 1.7.28-0~debian.13~trixie), containerd.io (= 1.7.28-1~debian.13~trixie), containerd.io (= 1.7.28-2~debian.13~trixie), containerd.io (= 1.7.29-1~debian.13~trixie), containerd.io (= 2.1.5-1~debian.13~trixie), containerd.io (= 2.2.0-2~debian.13~trixie), containerd.io (= 2.2.1-1~debian.13~trixie)
...
- **docker-model-plugin**
  - Latest version: 1.0.7-1~debian.13~trixie
  - Architectures: amd64
  - Suite: trixie
  - Components: stable
