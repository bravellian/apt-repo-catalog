# Microsoft - debian-12 - default (debian-12)

Repository ID: `microsoft-default-debian-12-bookworm-packages-microsoft-com`
OS: `debian-12`
Source: `[arch=amd64,arm64,armhf signed-by=/usr/share/keyrings/microsoft-prod.gpg] https://packages.microsoft.com/debian/12/prod bookworm main`
...
echo "deb [signed-by=/usr/share/keyrings/microsoft-microsoft-eb3e94adbe1229cf.gpg] [arch=amd64,arm64,armhf signed-by=/usr/share/keyrings/microsoft-prod.gpg] https://packages.microsoft.com/debian/12/prod bookworm main" | sudo tee /etc/apt/sources.list.d/microsoft-default-debian-12-bookworm-packages-microsoft-com.list >/dev/null
sudo apt-get update
```
