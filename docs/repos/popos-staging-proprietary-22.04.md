# Pop!_OS staging-proprietary - 22.04 (popos-22.04)

## Repository
- Repository ID: `popos-staging-proprietary-22.04`
- OS: `popos-22.04`
- Source: `http://apt.pop-os.org/staging-proprietary jammy main`
...
echo "deb [signed-by=/usr/share/keyrings/popos-lookup-204dd8aec33a7aff.gpg] http://apt.pop-os.org/staging-proprietary jammy main" | sudo tee /etc/apt/sources.list.d/popos-staging-proprietary-22.04.list >/dev/null
sudo apt-get update
```
