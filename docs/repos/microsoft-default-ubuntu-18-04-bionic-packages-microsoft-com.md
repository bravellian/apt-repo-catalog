# Microsoft - ubuntu-18.04 - default

## Repository
- Repository ID: `microsoft-default-ubuntu-18-04-bionic-packages-microsoft-com`
- Base URL: `https://packages.microsoft.com/ubuntu/18.04/prod`
...
echo "deb [arch=amd64 signed-by=/usr/share/keyrings/microsoft-microsoft-eb3e94adbe1229cf.gpg] https://packages.microsoft.com/ubuntu/18.04/prod bionic main" | sudo tee /etc/apt/sources.list.d/microsoft-default-ubuntu-18-04-bionic-packages-microsoft-com-bionic.list >/dev/null
sudo apt-get update
```
