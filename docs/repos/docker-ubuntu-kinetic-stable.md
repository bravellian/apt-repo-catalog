# Docker - Ubuntu (Kinetic) - stable (ubuntu-22.10)

Repository ID: `docker-ubuntu-kinetic-stable`
OS: `ubuntu-22.10`
Source: `https://download.docker.com/linux/ubuntu kinetic stable`
...
echo "deb [signed-by=/usr/share/keyrings/docker-gpg-8d81803c0ebfcd88.gpg] https://download.docker.com/linux/ubuntu kinetic stable" | sudo tee /etc/apt/sources.list.d/docker-ubuntu-kinetic-stable.list >/dev/null
sudo apt-get update
```
