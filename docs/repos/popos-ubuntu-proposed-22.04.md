# Pop!_OS ubuntu proposed - 22.04 (popos-22.04)

## Repository
- Repository ID: `popos-ubuntu-proposed-22.04`
- OS: `popos-22.04`
- Source: `http://apt.pop-os.org/ubuntu jammy-proposed main multiverse restricted universe`
...
echo "deb [signed-by=/usr/share/keyrings/popos-lookup-204dd8aec33a7aff.gpg] http://apt.pop-os.org/ubuntu jammy-proposed main multiverse restricted universe" | sudo tee /etc/apt/sources.list.d/popos-ubuntu-proposed-22.04.list >/dev/null
sudo apt-get update
```
