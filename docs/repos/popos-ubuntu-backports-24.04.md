# Pop!_OS ubuntu backports - 24.04 (popos-24.04)

## Repository
- Repository ID: `popos-ubuntu-backports-24.04`
- OS: `popos-24.04`
- Source: `http://apt.pop-os.org/ubuntu noble-backports main multiverse restricted universe`
...
echo "deb [signed-by=/usr/share/keyrings/popos-lookup-204dd8aec33a7aff.gpg] http://apt.pop-os.org/ubuntu noble-backports main multiverse restricted universe" | sudo tee /etc/apt/sources.list.d/popos-ubuntu-backports-24.04.list >/dev/null
sudo apt-get update
```
