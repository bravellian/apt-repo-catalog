# Pop!_OS staging-ubuntu (master) - 22.04 (popos-22.04)

## Repository
- Repository ID: `popos-staging-ubuntu-master-22.04`
- OS: `popos-22.04`
- Source: `[arch=amd64] http://apt.pop-os.org/staging-ubuntu/master jammy main`
...
echo "deb [signed-by=/usr/share/keyrings/popos-lookup-204dd8aec33a7aff.gpg] [arch=amd64] http://apt.pop-os.org/staging-ubuntu/master jammy main" | sudo tee /etc/apt/sources.list.d/popos-staging-ubuntu-master-22.04.list >/dev/null
sudo apt-get update
```
