# Docker - Ubuntu (Jammy) - stable (ubuntu-22.04)

## Repository
- Repository ID: `docker-ubuntu-jammy-stable`
- OS: `ubuntu-22.04`
- Source: `https://download.docker.com/linux/ubuntu jammy stable`
...
echo "deb [signed-by=/usr/share/keyrings/docker-gpg-8d81803c0ebfcd88.gpg] https://download.docker.com/linux/ubuntu jammy stable" | sudo tee /etc/apt/sources.list.d/docker-ubuntu-jammy-stable.list >/dev/null
sudo apt-get update
```
...
- **docker-model-plugin**
  - Latest version: 1.0.7-1~ubuntu.22.04~jammy
  - Architectures: amd64
  - Suite: jammy
  - Components: stable
