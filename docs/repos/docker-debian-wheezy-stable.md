# Docker - Debian (Wheezy) - stable (debian-7)

## Repository
- Repository ID: `docker-debian-wheezy-stable`
- OS: `debian-7`
- Source: `https://download.docker.com/linux/debian wheezy stable`
...
echo "deb [signed-by=/usr/share/keyrings/docker-gpg-8d81803c0ebfcd88.gpg] https://download.docker.com/linux/debian wheezy stable" | sudo tee /etc/apt/sources.list.d/docker-debian-wheezy-stable.list >/dev/null
sudo apt-get update
```
