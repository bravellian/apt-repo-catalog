# Microsoft - ubuntu-18.10 - default (ubuntu-18.10)

## Repository
- Repository ID: `microsoft-default-ubuntu-18-10-cosmic-packages-microsoft-com`
- OS: `ubuntu-18.10`
- Source: `[arch=amd64] https://packages.microsoft.com/ubuntu/18.10/prod cosmic main`
...
echo "deb [signed-by=/usr/share/keyrings/microsoft-microsoft-eb3e94adbe1229cf.gpg] [arch=amd64] https://packages.microsoft.com/ubuntu/18.10/prod cosmic main" | sudo tee /etc/apt/sources.list.d/microsoft-default-ubuntu-18-10-cosmic-packages-microsoft-com.list >/dev/null
sudo apt-get update
```
