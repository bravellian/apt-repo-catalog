# Docker - Ubuntu (Hirsute) - stable (ubuntu-21.04)

Repository ID: `docker-ubuntu-hirsute-stable`
OS: `ubuntu-21.04`
Source: `https://download.docker.com/linux/ubuntu hirsute stable`
...
echo "deb [signed-by=/usr/share/keyrings/docker-gpg-8d81803c0ebfcd88.gpg] https://download.docker.com/linux/ubuntu hirsute stable" | sudo tee /etc/apt/sources.list.d/docker-ubuntu-hirsute-stable.list >/dev/null
sudo apt-get update
```
