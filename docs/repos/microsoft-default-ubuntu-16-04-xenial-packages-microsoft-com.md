# Microsoft - ubuntu-16.04 - default (ubuntu-16.04)

## Repository
- Repository ID: `microsoft-default-ubuntu-16-04-xenial-packages-microsoft-com`
- OS: `ubuntu-16.04`
- Source: `[arch=amd64] https://packages.microsoft.com/ubuntu/16.04/prod xenial main`
...
echo "deb [signed-by=/usr/share/keyrings/microsoft-microsoft-eb3e94adbe1229cf.gpg] [arch=amd64] https://packages.microsoft.com/ubuntu/16.04/prod xenial main" | sudo tee /etc/apt/sources.list.d/microsoft-default-ubuntu-16-04-xenial-packages-microsoft-com.list >/dev/null
sudo apt-get update
```
