...
echo "deb [signed-by=/usr/share/keyrings/proxmox-archive-keyring-trixie.gpg] https://enterprise.proxmox.com/debian/pve trixie pve-enterprise" | sudo tee /etc/apt/sources.list.d/proxmox-ve-9-enterprise-trixie.list >/dev/null
sudo apt-get update
```
