# Microsoft - ubuntu-16.10 - default

## Repository
- Repository ID: `microsoft-default-ubuntu-16-10-yakkety-packages-microsoft-com`
- Base URL: `https://packages.microsoft.com/ubuntu/16.10/prod`
...
echo "deb [arch=amd64 signed-by=/usr/share/keyrings/microsoft-microsoft-eb3e94adbe1229cf.gpg] https://packages.microsoft.com/ubuntu/16.10/prod yakkety main" | sudo tee /etc/apt/sources.list.d/microsoft-default-ubuntu-16-10-yakkety-packages-microsoft-com-yakkety.list >/dev/null
sudo apt-get update
```
