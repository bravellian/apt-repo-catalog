# Pop!_OS ubuntu updates - 22.04 (popos-22.04)

## Repository
- Repository ID: `popos-ubuntu-updates-22.04`
- OS: `popos-22.04`
- Source: `http://apt.pop-os.org/ubuntu jammy-updates main multiverse restricted universe`
...
echo "deb [signed-by=/usr/share/keyrings/popos-lookup-204dd8aec33a7aff.gpg] http://apt.pop-os.org/ubuntu jammy-updates main multiverse restricted universe" | sudo tee /etc/apt/sources.list.d/popos-ubuntu-updates-22.04.list >/dev/null
sudo apt-get update
```
