# Microsoft - ubuntu-23.10 - default (ubuntu-23.10)

## Repository
- Repository ID: `microsoft-default-ubuntu-23-10-mantic-packages-microsoft-com`
- OS: `ubuntu-23.10`
- Source: `[arch=amd64,arm64,armhf signed-by=/usr/share/keyrings/microsoft-prod.gpg] https://packages.microsoft.com/ubuntu/23.10/prod mantic main`
...
echo "deb [signed-by=/usr/share/keyrings/microsoft-microsoft-eb3e94adbe1229cf.gpg] [arch=amd64,arm64,armhf signed-by=/usr/share/keyrings/microsoft-prod.gpg] https://packages.microsoft.com/ubuntu/23.10/prod mantic main" | sudo tee /etc/apt/sources.list.d/microsoft-default-ubuntu-23-10-mantic-packages-microsoft-com.list >/dev/null
sudo apt-get update
```
