# Microsoft - ubuntu-23.04 - default (ubuntu-23.04)

## Repository
- Repository ID: `microsoft-default-ubuntu-23-04-lunar-packages-microsoft-com`
- OS: `ubuntu-23.04`
- Source: `[arch=amd64,armhf,arm64] https://packages.microsoft.com/ubuntu/23.04/prod lunar main`
...
echo "deb [signed-by=/usr/share/keyrings/microsoft-microsoft-eb3e94adbe1229cf.gpg] [arch=amd64,armhf,arm64] https://packages.microsoft.com/ubuntu/23.04/prod lunar main" | sudo tee /etc/apt/sources.list.d/microsoft-default-ubuntu-23-04-lunar-packages-microsoft-com.list >/dev/null
sudo apt-get update
```
